...
class Orchestrator:
    ...
    def executor(self):
        ...
        print(".....Running the Table Identifier Agent ......")
        ta_agent_result = self.TA.run()
        print("....Table identifier result... "+str(ta_agent_result) )
        print("Running SQL Generation Agent")
        sql_gen_agent = SQLGenerationAgent(self.user_question , ta_agent_result['relevant_tables'])
        sql_gen_res = sql_gen_agent.run()
        print("....SQL generation Result... "+sql_gen_res)
